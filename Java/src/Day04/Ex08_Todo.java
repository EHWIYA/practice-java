 ...
 * 메뉴를 통해 할 일을 추가, 조회, 상태변경을 할 수 있는 기능을 구현
 * 기능
 * 1. 할 일 추가
 * 2. 할 일 목록
 * 3. 상태 변경
        ...
        while (true) {
            ...
            switch (menuNo) {
                case 1:  // 할 일 추가
                    ...
                    todoList[count] = new Todo(name);            // 할 일 추가
                    count++;                                     // 할 일 개수 증가
                ...
                case 3:  // 상태 변경
                    ...
                    sc.nextLine();
                    // 상태 변경
                    Status updatedStatus = statusList[statusNo - 1];
                    todoList[index].setStatus(updatedStatus);
                    System.out.println("작업상태를 " + updatedStatus.getValue() + "(으/로) 변경하였습니다.");
                    break;
